...
<html>
  ...
  <body>
	...
	<form>
		<table cellpadding="5">
			<tr><td style="width: 120px;">新闻标题：</td><td style="width: 880px;">
				<input id="title" class="easyui-textbox" data-options="prompt:'新闻标题',required:true" style="width: 90%;height: 32px;">
			</td>
			</tr>
			<tr><td>新闻发布者：</td><td>
				<input id="cruser" class="easyui-textbox" value="${me.xm}" data-options="prompt:'发布人',required:true" style="width: 90%;height: 32px;">
			</td></tr>
			...
			var c=$("#cruser").textbox("getValue");
				...
				$.ajax({
					...
					success:function(res){
						if(res.ok){
							parent.$.messager.alert("系统提示","你已添加新闻:"+$("#title").val(),"info");
						}else{
